...
public class TP1_NoDock extends SequentialCommandGroup{
    public TP1_NoDock(DrivetrainSubsystem drivetrain, Manipulator mManipulator){
        ...
        PathPlannerTrajectory P1toMarker = AutoChooser.openTrajectoryFileForAlliance("BLUE_TopMarker_P1-M", new PathConstraints(3, 0.75));
        addCommands(
