...
public class BLUE_TOP_2CONESHIGH extends SequentialCommandGroup{
    public BLUE_TOP_2CONESHIGH(DrivetrainSubsystem drivetrain, Manipulator mManipulator){
        ...
        addCommands(
            ...
            mManipulator.getGrasper().setPercentOutputCommand(-1).withTimeout(0.5),
            mManipulator.swapAutoScoreCommand().withTimeout(0.03),
