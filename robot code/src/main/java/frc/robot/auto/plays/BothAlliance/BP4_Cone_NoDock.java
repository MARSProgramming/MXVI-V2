...
public class BP4_Cone_NoDock extends SequentialCommandGroup{
    public BP4_Cone_NoDock(DrivetrainSubsystem drivetrain, Manipulator mManipulator){
        ...
        PathPlannerTrajectory MarkertoP4 = AutoChooser.openTrajectoryFileForAlliance("BLUE_BottomMarker_M-P4Cone", new PathConstraints(1.5, 1));
        PathPlannerTrajectory P4toMarker = AutoChooser.openTrajectoryFileForAlliance("BLUE_BottomMarker_P4-MCone", new PathConstraints(1.5, 1));
        addCommands(
