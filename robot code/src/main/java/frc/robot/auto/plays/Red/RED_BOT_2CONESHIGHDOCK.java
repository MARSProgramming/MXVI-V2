...
public class RED_BOT_2CONESHIGHDOCK extends SequentialCommandGroup{
    public RED_BOT_2CONESHIGHDOCK(DrivetrainSubsystem drivetrain, Manipulator mManipulator){
