...
public class TScoreGivenLeaveDock extends SequentialCommandGroup{
    ...
    public TScoreGivenLeaveDock(DrivetrainSubsystem drivetrain, Manipulator mManipulator){
        ...
        PathPlannerTrajectory LeaveCommunity = AutoChooser.openTrajectoryFile("BLUE_TopMarker_M-C", new PathConstraints(1.5, 0.5));
        addCommands(
