...
public class RED_TOP_2HIGHDOCK extends SequentialCommandGroup{
    public RED_TOP_2HIGHDOCK(DrivetrainSubsystem drivetrain, Manipulator mManipulator){
        addRequirements(drivetrain);

        PathPlannerTrajectory P1 = AutoChooser.openTrajectoryFileForRed("RED_TOP_G-P1", new PathConstraints(3, 2));
        PathPlannerTrajectory ScoreP1 = AutoChooser.openTrajectoryFileForRed("RED_TOP_P1-G", new PathConstraints(3, 2));
        PathPlannerTrajectory Dock = AutoChooser.openTrajectoryFileForRed("RED_TOP_G-C", new PathConstraints(1, 1));
        addCommands(
