...
public class TP1_Cube_Dock extends SequentialCommandGroup{
    public TP1_Cube_Dock(DrivetrainSubsystem drivetrain, Manipulator mManipulator){
        ...
        PathPlannerTrajectory P1toMarker = AutoChooser.openTrajectoryFile("BLUE_TopMarker_P1-M", new PathConstraints(3, 1));
        PathPlannerTrajectory CSPath = AutoChooser.openTrajectoryFile("BLUE_TopMarker_M-CNoLeave", new PathConstraints(1.0, 0.5));
        addCommands(
