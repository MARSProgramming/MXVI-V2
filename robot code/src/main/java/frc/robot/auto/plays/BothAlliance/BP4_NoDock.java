...
public class BP4_NoDock extends SequentialCommandGroup{
    public BP4_NoDock(DrivetrainSubsystem drivetrain, Manipulator mManipulator){
        addRequirements(drivetrain);

        PathPlannerTrajectory MarkertoP4 = AutoChooser.openTrajectoryFileForAlliance("BLUE_BottomMarker_M-P4", new PathConstraints(1.5, 0.75));
        PathPlannerTrajectory P4toMarker = AutoChooser.openTrajectoryFileForAlliance("BLUE_BottomMarker_P4-M", new PathConstraints(1.5, 0.75));
        addCommands(
