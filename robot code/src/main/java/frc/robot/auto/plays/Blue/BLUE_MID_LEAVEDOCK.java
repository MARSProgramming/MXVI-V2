...
public class BLUE_MID_LEAVEDOCK extends SequentialCommandGroup{
    public BLUE_MID_LEAVEDOCK(DrivetrainSubsystem drivetrain){
        addRequirements(drivetrain);

        PathPlannerTrajectory LeaveCommunity = AutoChooser.openTrajectoryFileForBlue("BLUE_MID_LEAVE", new PathConstraints(1, 0.5));
        PathPlannerTrajectory Dock = AutoChooser.openTrajectoryFileForBlue("BLUE_MID_LEAVE-DOCK", new PathConstraints(1, 0.5));
        addCommands(
