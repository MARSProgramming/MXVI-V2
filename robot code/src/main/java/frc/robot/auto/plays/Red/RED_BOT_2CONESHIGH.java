...
public class RED_BOT_2CONESHIGH extends SequentialCommandGroup{
    public RED_BOT_2CONESHIGH(DrivetrainSubsystem drivetrain, Manipulator mManipulator){
        addRequirements(drivetrain);

        PathPlannerTrajectory P1 = AutoChooser.openTrajectoryFileForRed("RED_BOT_G-P4", new PathConstraints(2, 1));
        PathPlannerTrajectory ScoreP1 = AutoChooser.openTrajectoryFileForRed("RED_BOT_P4-G", new PathConstraints(2, 1));
        addCommands(
