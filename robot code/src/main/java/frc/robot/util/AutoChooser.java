...
import frc.robot.auto.plays.Red.RED_BOT_2CONESHIGH;
import frc.robot.auto.plays.Red.RED_BOT_2CONESHIGHDOCK;
...
public class AutoChooser {
    ...
    public AutoChooser(DrivetrainSubsystem mDrivetrainSubsystem, Manipulator mManipulator){
        ...
        autoChooser.addOption("3RED: 2 Pieces", new RED_BOT_2CONESHIGH(mDrivetrainSubsystem, mManipulator));
        autoChooser.addOption("3RED: 2 Pieces Dock", new RED_BOT_2CONESHIGHDOCK(mDrivetrainSubsystem, mManipulator));
