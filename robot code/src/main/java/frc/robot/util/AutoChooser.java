...
import frc.robot.auto.plays.Blue.BbScoreGivenLeaveDock;
...
import frc.robot.auto.plays.Red.RbScoreGivenLeave;
...
public class AutoChooser {
    ...
    public AutoChooser(DrivetrainSubsystem mDrivetrainSubsystem, Manipulator mManipulator){
        ...
        autoChooser.addOption("BLUE-BOTTOM: Score Piece 4, No Dock", new BbP4_NoDock(mDrivetrainSubsystem, mManipulator));
        ...
        autoChooser.addOption("BLUE-BOTTOM: Score Given Piece, Leave Community", new BbScoreGivenLeave(mDrivetrainSubsystem, mManipulator));
        autoChooser.addOption("BLUE-BOTTOM: Score Given Piece, Leave Community, Dock", new BbScoreGivenLeaveDock(mDrivetrainSubsystem, mManipulator));
        ...
        autoChooser.addOption("RED-BOTTOM: Score Given Piece", new RbScoreGiven(mDrivetrainSubsystem, mManipulator));
        autoChooser.addOption("RED-BOTTOM: Score Given Piece, Leave Community", new RbScoreGivenLeave(mDrivetrainSubsystem, mManipulator));
