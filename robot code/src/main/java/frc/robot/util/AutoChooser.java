...
import frc.robot.auto.plays.Blue.BLUE_BOT_2CONESHIGH;
import frc.robot.auto.plays.Blue.BLUE_BOT_2CONESHIGHDOCK;
...
import frc.robot.auto.plays.Blue.BLUE_TOP_2CONESHIGH;
import frc.robot.auto.plays.Blue.BLUE_TOP_2CONESHIGHDOCK;
...
public class AutoChooser {
    ...
    public AutoChooser(DrivetrainSubsystem mDrivetrainSubsystem, Manipulator mManipulator){
        ...
        autoChooser.addOption("1BLUE: 2 Piees High", new BLUE_TOP_2CONESHIGH(mDrivetrainSubsystem, mManipulator));
        autoChooser.addOption("1BLUE: 2 Pieces High Dock", new BLUE_TOP_2CONESHIGHDOCK(mDrivetrainSubsystem, mManipulator));
        ...
        autoChooser.addOption("3BLUE: 2 Pieces", new BLUE_BOT_2CONESHIGH(mDrivetrainSubsystem, mManipulator));
        autoChooser.addOption("3BLUE: 2 Pieces Dock", new BLUE_BOT_2CONESHIGHDOCK(mDrivetrainSubsystem, mManipulator));
